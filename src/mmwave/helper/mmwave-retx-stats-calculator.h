...
#ifndef MMWAVE_RETX_STATS_CALCULATOR_H_
#define MMWAVE_RETX_STATS_CALCULATOR_H_
...
class MmWaveRetxStatsCalculator : public Object
{
public:
  /**
   * Class constructor
   */
  MmWaveRetxStatsCalculator ();
...
#endif /* MMWAVE_RETX_STATS_CALCULATOR_H_ */
